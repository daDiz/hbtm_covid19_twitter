...
#pos = nx.bipartite_layout(g,republicans)
#pos = custom_layout(g, shift=50, step=10.0, upper=1000)
#pos = custom_grid_layout(g, shift=0.5, step=20)
pos = custom_grid_layout_test(g, shift=0.5, step=10)
